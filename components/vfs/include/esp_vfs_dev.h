...
#if defined(__GNUC__) /* #CUSTOM@NDRS */
__attribute__((deprecated("Please use esp_vfs_dev_uart_port_set_rx_line_endings")))
#endif
;
...
#if defined(__GNUC__) /* #CUSTOM@NDRS */
__attribute__((deprecated("Please use esp_vfs_dev_uart_port_set_tx_line_endings")))
#endif
;
